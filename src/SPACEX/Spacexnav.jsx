...
import content from "./spacexnav.module.css"
const Spacexnav = () => {
  return (
    <div>
        <section id={content.section1}>
                <main id={content.mainnav}>
          ...
          <path class="fill-white" d="M399,0.7c-80,4.6-117,38.8-125.3,46.9l-1.7,1.6h14.8C326.8,9.1,384.3,2,399,0.7L399,0.7z"></path>
                    ...
                    <nav className={content.nav}>
                        <ol>
                            ...
                            <li><div className={content.space}></div></li>
                ...
                <aside id={content.AsideContent}>
                    <div className={content.empity}></div>
                    <div className={content.content}>
                        <h4>RECENT LAUNCH</h4>
                        <h2>INTELSAT IS-40E</h2>
                        <h2>MISSION</h2> <br /><br />
                        <a href="" ><div>REWATCH</div></a>
                    </div>
                </aside>
            </section>

            <section id={content.section2}></section>
            <section id={content.section3}></section>
    </div>
  )
}
